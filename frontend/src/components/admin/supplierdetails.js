...
<div class="card text-center">
  ...
  name
    <li class="list-group-item">{purchase.supplier_name}</li>
    telephone
    <li class="list-group-item">{purchase.supplier_tel_no}</li>
    address
    <li class="list-group-item">{purchase.supplier_address}</li>
